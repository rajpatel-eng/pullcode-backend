...
public class CliPushService {
    ...
    public CliPushResponse push(
        ...
        log.info("CLI push success: project={} commit={} user={} files={}",
                project.getId(), commitHash, user.getId(), extracted.getTotalFiles());
        ...
        return CliPushResponse.builder()
                ...
                .message("✓ Pushed to " + project.getTitle() + " [" + commitHash + "]")
                .build();
    }
    ...
    public ProjectCliHistoryResponse getCliHistory(Long projectId, Long userId) {
        ...
        List<CliCommitHistory> commits =
                commitHistoryRepository.findByZipProjectOrderByPushedAtDesc(project);
